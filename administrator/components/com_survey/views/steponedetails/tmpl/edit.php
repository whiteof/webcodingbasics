...
<form action="<?php echo JRoute::_('index.php?option=com_survey&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="product-form" class="form-validate form-horizontal">
	<div class="row-fluid">
		<!-- Begin Newsfeed -->
	...
	<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'details')); ?>
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'details', empty($this->item->id) ? JText::_('COM_SURVEY_NEW_PRODUCT', true) : JText::sprintf('COM_SURVEY_EDIT_PRODUCT', $this->item->id, true)); ?>
