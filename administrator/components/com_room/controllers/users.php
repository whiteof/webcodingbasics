...
class RoomControllerUsers extends JControllerAdmin
{
	...
	public function sendEmailOne($user)
	{
		...
		$mailer->setSubject('Бесплатный второй урок курса "Как стать web-программистом и найти работу в США"');
		$mailer->isHTML(true);
		$mailer->Encoding = 'base64';
		$user = JUser::getInstance($user->id);
		$body = '<p>Привет,</p>'.
				'<p>В данное время я работаю над усовершенствованием своего курса “Как стать веб-программистом и найти работу в США”. Я знаю, ты еще не прошел полный курс и тебе наверняка будет трудно оценить его по одному уроку, но все же я буду очень признателен если ты оставишь небольшой feedback.</p>'.
	...
	public function sendEmailThree($user)
	{
		...
		$body = '
			...
			<p>Это займет меньше минуты и существенно поможет понять мне что нитак и возможно сделать предложение, которое тебя действительно заинтересует.</p>
			<p>
				Заранее спасибо,<br />
				Сергей Холодинский<br />
