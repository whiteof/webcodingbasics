...
<?php if (empty($this->items)) : ?>
	<?php if (count($this->children[$this->category->id]) == 0) : ?>
		...
		<p class="alert alert-error"><?php echo JText::_('COM_CONTENT_NO_ARTICLES'); ?></p>
		<p align="center"><a class="btn btn-primary" href="#" data-toggle="modal" data-target="#modalBuy">Получить доступ к уроку</a></p>
		<?php endif; ?>
	<?php endif; ?>		
