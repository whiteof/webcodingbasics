		...
		<?php if($this->countModules('home-message')): ?>
			<div class="description">
				<div class="container">
					...
					<h4 class="desc-comment">Данная программа создана чтобы помоч людям стать программистами и включает себя экспресс видео курс по веб-программированию и помощь в трудоустройстве в США</h4>
					...
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="custom">
								...
								<p>
									...
									Пройдя же весь курс, мы с тобой создадим реальный интернет магазин. Ты получишь знания и навыки, с которыми смело можно начинать поиск работы и реально менять свою жизнь.<br><br>
								</p>
						...
						<div class="col-sm-6">
							<div class="custom employment">
								...
								<ol>
									<li>Внутреннее интервью со мной или моими помошниками для выяснения твоей текущей ситуации и знаний основ программирования после прохождения экспресс видеокурса</li>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-6">
							...
							<p>После того как ты самостоятельно пройдешь экспресс видеокурс по основам веб-программирования, мы назначаем внутреннее телефонное интервью со мной или моими помошниками. На этом интервью мы выясняем твои знания в веб-программировании, т.е. успешно ли ты прошел видеокурс, отвечаем на твои вопросы, составляем рекоммендации - в каком направлении тебе стоит подтянуть свои знания и навыки. Если ты успешно усвоил большую часть материала и готов к дальнейшим действиям, мы открываем тебе доступ к закрытой группе в контакте, где ты можешь задавать вопросы мне и моим помошникам, выставлять какие либо спорные моменты на обсуждение. В этой группе я регулярно публикую свежие вакансии. После прохождения интервью ты сможешь делать работу над ошибками, публикуя в группе вопросы которые у тебя вызвали трудности. Таким образом ты получаешь пожизненную поддержку в вопросах поиска работы!</p>
						</div>
						<div class="col-sm-6">
							<h4>2. Работа над резюме</h4>
							<p>Следующим этапом трудоустройства идет работа над резюме. Мы поможем тебе составить резюме. Правильно составленное резюме - это 50% успеха. Ведь только когда твое резюме будет привлекать работадателей и рекрутеров, начнет работать закон больших чисел, т.е. тебя постоянно будут звать на интервью, и рано или поздно ты точно найдешь работу, т.к. на каждом интервью вопросы будут очень похожими. Мы обьясним тебе куда отправлять свое резюме, на каких сайтах регистрироваться, как создавать профайлы, чтобы они соответствовали твоему резюме и выглядели правдоподобно.</p>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-6">
							<h4>3. Подготовка к интервью</h4>
							<p>Далее мы готовим тебя к интервью - ты узнаешь как себя вести, что говорить рекрутерам, а что конкретно работодателю. Мы поможем тебе составить хороший рассказ о себе, чтобы он был краткий и в то же время отвечал на большенство вопросов, которые должен задать рекрутер. Такой рассказ особенно важен, если уровень твоего английского оставляет желать лучшего. Ведь первое интервью с рекрутером или работодателем как правило проходит по телефону, да еще и связь всегда оставляет желать лучшего. Т.е. чем больше ты расскажешь сам, тем меньше у тебя спросят.</p>
						</div>
						<div class="col-sm-6">
