 ...
 * @since       1.6
 */
class SurveyModelProducts extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__survey_products') . ' AS a');

		// Join over the language
		$query->select('b.title AS category_title')
			->join('LEFT', $db->quoteName('#__survey_categories') . ' AS b ON b.id = a.category_id');
